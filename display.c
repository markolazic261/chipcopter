/*
 * Display functionality for ChipKit Uno32 sheild.
 *
 * @author h4xxel
...
/*
 * Function implementation by David C. Rankin
 * http://stackoverflow.com/a/23840699/3078479
 */
...
void display_init() {
	...
	display_string(0, "Wow");
	display_string(1, "Much project");
	display_string(2, "Such quadcopter");
	display_string(3, "Very fly");
	display_update();
